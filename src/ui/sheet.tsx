...
>(({ className, ...props }, ref) => {
  ...
  return (
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:duration-0 data-[state=open]:duration-0",
        className,
      )}
